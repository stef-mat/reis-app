...
import { Euro, Heart, Car, Bike, X, Calendar, Plus } from 'lucide-react';
            ...
            <article className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group flex flex-col overflow-hidden">
                ...
                <div className="p-4 sm:p-5 pb-0">
                    <div className="flex items-start justify-between mb-3">
                        ...
                        {/* Action Buttons - Favorite, Plan & Hide */}
                        <div className="flex items-center gap-2">
                            {/* Favorite Button */}
                            <button 
                            ...
                            <button 
                                ...
                                className={`p-2 rounded-full transition-all duration-200 transform hover:scale-110 focus:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
                                    isPlanned
                                        ? 'bg-blue-500 text-white shadow-lg'
                                        : 'bg-slate-100 text-blue-500 hover:bg-blue-50 shadow-md'
                                }`}
